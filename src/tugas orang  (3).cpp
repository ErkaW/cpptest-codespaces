...
void beli(){
    do{
        ...
        cin >> jumlah;
        cout << " ================================" << endl;
        cout << " Nama produk : " << produk[id - 1] << endl;
        cout << " Harga produk : " << harga[id - 1] << endl;
        cout << " Jumlah produk : " << jumlah << endl;
        cout << " Total harga : " << harga[id - 1] * jumlah << endl;
        cout << " ================================" << endl;
        keranjang[id - 1] = jumlah;
